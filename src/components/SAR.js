        ...
        <Container>
          ...
          <div className="w3-panel w3-border w3-border-white boxshadow">
            ...
            <div className="material-content">
              Dr Shiv Mohan, Founder Chair, IEEE Geoscience and RS Society took
              a session explaining about Basics of SAR imagery, Data Analysis
              and its techniques with SAR, Model based analysis and some of the
              applications of SAR data in Crop analysis, Flood damage
              assessment, forest biomass. SAR data To download the SAR data
              ...
              ​
              <h4 className="material-content main-bg">
